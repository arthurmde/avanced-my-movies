...
class ProfessionalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professional" do
    assert_difference('Professional.count') do
      post professionals_url, params: { professional: { birthdate: @professional.birthdate, country: @professional.country, gender: @professional.gender, name: @professional.name, type: @professional.type } }
    end
  ...
  test "should update professional" do
    patch professional_url(@professional), params: { professional: { birthdate: @professional.birthdate, country: @professional.country, gender: @professional.gender, name: @professional.name, type: @professional.type } }
